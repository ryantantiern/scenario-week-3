...
python /home/ec2-user/s-ref/deployment-scripts/github-listener/update_webhooks.py 2>&1 | tee /home/ec2-user/webhook_log.txt

# 03. Start GitHub listener (comment out if using django implementation)
#python /home/ec2-user/s-ref/deployment-scripts/github-listener/server.py &